...
-  A continuous random variable is one that has possible values that form an interval along the real number line. In other words, a continuous random variable can assume any value over
...
-  The area under the probability distribution curve of a continuous random variable between
